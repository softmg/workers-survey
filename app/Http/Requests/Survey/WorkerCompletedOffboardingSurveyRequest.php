...
class WorkerCompletedOffboardingSurveyRequest extends FormRequest
{
    ...
    {
        return [
            'dateFrom.before_or_equal' => __('exception.date_from_before_or_equal_date_to'),
            'dateTo.after_or_equal' => __('exception.date_to_after_or_equal_date_from'),
        ];
    }
}
